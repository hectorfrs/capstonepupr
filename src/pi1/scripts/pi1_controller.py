...
import pi1.lib.spectrometer as spect
import time
import datetime
...
#spect.init()
#spect.hwVersion()
LED1 = spect.shutterLED("AS72651",True)
LED2 = spect.shutterLED("AS72652",True)
LED3 = spect.shutterLED("AS72653",True)
SetLED = spect.setBlueLED(True)
ReadAllData()
