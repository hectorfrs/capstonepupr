...
sudo apt install -y python3 python3-pip python3-smbus i2c-tools git python3-tk mosquitto mosquitto-clients

# Instalar paquetes de Python
echo "Instalando paquetes de Python..."
pip3 install pyyaml paho-mqtt AWSIoTPythonSDK boto3 opencv-python Pillow
...
# Asegurar que Mosquitto está en ejecución
echo "Verificando que el broker Mosquitto esté en ejecución..."
